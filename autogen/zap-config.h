...
#define ZCL_GENERATED_CLUSTERS { \
  { 0x0021, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[0]), 6, 280, CLUSTER_MASK_CLIENT, NULL }, /* 0, Endpoint Id: 242, Cluster: Green Power, Side: client*/ \
	  { 0x0021, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[6]), 12, 302, CLUSTER_MASK_SERVER, NULL } /* 1, Endpoint Id: 242, Cluster: Green Power, Side: server*/ \
	 }
...
#define ZCL_GENERATED_ENDPOINT_TYPES { \
  { ((sl_zigbee_af_cluster_t*)&(generatedClusters[0])), 2, 582 }, \
	 } 
...
#define ZCL_ATTRIBUTE_MAX_SIZE (582)
...
#define SL_ZIGBEE_ZCL_GENERATED_COMMAND_COUNT  (15)
...
#define SL_ZIGBEE_ZCL_GREEN_POWER_CLUSTER_SERVER_ENDPOINT_COUNT (1)
